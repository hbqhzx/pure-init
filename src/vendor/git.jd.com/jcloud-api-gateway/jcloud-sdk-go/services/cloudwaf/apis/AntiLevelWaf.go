...
type AntiLevelWafRequest struct {
    ...
    /* 请求  */
    Req *cloudwaf.AntiLevelWafReq `json:"req"`
}
...
func NewAntiLevelWafRequest(
    regionId string,
    req *cloudwaf.AntiLevelWafReq,
) *AntiLevelWafRequest {

	return &AntiLevelWafRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/waf:antiLevel",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param req: 请求(Required) */
func (r *AntiLevelWafRequest) SetReq(req *cloudwaf.AntiLevelWafReq) {
    r.Req = req
}
