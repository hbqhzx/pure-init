...
func NewGetDomainLbConfigRequest(
	...
	return &GetDomainLbConfigRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/domain/{domain}/getDomainLbConfig",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param domain: 域名(Required) */
func (r *GetDomainLbConfigRequest) SetDomain(domain string) {
    r.Domain = domain
}

/* param req: 请求(Required) */
func (r *GetDomainLbConfigRequest) SetReq(req *cloudwaf.CommonReq) {
    r.Req = req
}
...
type GetDomainLbConfigResult struct {
    ...
    Config cloudwaf.LbConfig `json:"config"`
}