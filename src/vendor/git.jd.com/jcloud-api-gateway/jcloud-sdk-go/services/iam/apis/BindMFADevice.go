...
type BindMFADeviceRequest struct {
    ...
    /* 被绑定的账号（目前支持情况：默认不填的情况表示给自己绑定，填写子账号的name表示主账号给子账号绑定) (Optional) */
...
/*
 * param authenticationCode1: 第一组动态密码 (Required)
 * param authenticationCode2: 第二组动态密码 (Required)
 *
...
/*
 * param boundAccount: 被绑定的账号（目前支持情况：默认不填的情况表示给自己绑定，填写子账号的name表示主账号给子账号绑定) (Optional)
 * param authenticationCode1: 第一组动态密码 (Required)
 * param authenticationCode2: 第二组动态密码 (Required)
 */
