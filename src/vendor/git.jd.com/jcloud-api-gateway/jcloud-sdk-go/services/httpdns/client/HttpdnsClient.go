...
import (
    ...
    httpdns "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/httpdns/apis"
    "encoding/json"
    "errors"
)
 ...
 */
func (c *HttpdnsClient) QueryCount(request *httpdns.QueryCountRequest) (*httpdns.QueryCountResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &httpdns.QueryCountResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查看剩余额度和使用额度 */
func (c *HttpdnsClient) GetDataPlanInfo(request *httpdns.GetDataPlanInfoRequest) (*httpdns.GetDataPlanInfoResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &httpdns.GetDataPlanInfoResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
分页展示，按照降序排列。
 */
func (c *HttpdnsClient) QueryTotalCount(request *httpdns.QueryTotalCountRequest) (*httpdns.QueryTotalCountResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &httpdns.QueryTotalCountResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查询用户的最近一年的流量包 */
func (c *HttpdnsClient) GetDataPlan(request *httpdns.GetDataPlanRequest) (*httpdns.GetDataPlanResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &httpdns.GetDataPlanResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
