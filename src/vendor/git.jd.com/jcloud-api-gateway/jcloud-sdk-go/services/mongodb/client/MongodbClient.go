...
import (
    ...
    mongodb "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/mongodb/apis"
    "encoding/json"
    "errors"
)
...
/* 批量删除 */
func (c *MongodbClient) DeleteMongoDbs(request *mongodb.DeleteMongoDbsRequest) (*mongodb.DeleteMongoDbsResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &mongodb.DeleteMongoDbsResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 获取topology结构 */
func (c *MongodbClient) DescribeTopology(request *mongodb.DescribeTopologyRequest) (*mongodb.DescribeTopologyResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &mongodb.DescribeTopologyResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 资源权限校验 */
func (c *MongodbClient) VerifyInstanceValidation(request *mongodb.VerifyInstanceValidationRequest) (*mongodb.VerifyInstanceValidationResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &mongodb.VerifyInstanceValidationResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 获取配额 */
func (c *MongodbClient) DescribeUserQuota(request *mongodb.DescribeUserQuotaRequest) (*mongodb.DescribeUserQuotaResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &mongodb.DescribeUserQuotaResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
