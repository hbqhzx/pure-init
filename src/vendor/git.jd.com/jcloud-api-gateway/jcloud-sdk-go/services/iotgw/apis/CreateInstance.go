...
type CreateInstanceRequest struct {
    ...
    /* iotgw实例的相关配置  */
    InstanceSpec *iotgw.InstanceSpec `json:"instanceSpec"`
}

/*
 * param regionId: regionId (Required)
 * param instanceSpec: iotgw实例的相关配置 (Required)
 *
 * @Deprecated, not compatible when mandatory parameters changed
 */
func NewCreateInstanceRequest(
    regionId string,
    instanceSpec *iotgw.InstanceSpec,
...
/* param instanceSpec: iotgw实例的相关配置(Required) */
func (r *CreateInstanceRequest) SetInstanceSpec(instanceSpec *iotgw.InstanceSpec) {
