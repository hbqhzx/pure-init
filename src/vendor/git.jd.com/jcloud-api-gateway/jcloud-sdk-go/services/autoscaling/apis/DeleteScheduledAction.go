 ...
 * param scheduledActionUuid: 定时任务uuid (Required)
 */
func NewDeleteScheduledActionRequestWithAllParams(
    regionId string,
    asGroupUuid string,
    scheduledActionUuid string,
) *DeleteScheduledActionRequest {
...
func NewDeleteScheduledActionRequestWithoutParam() *DeleteScheduledActionRequest {
...
/* param regionId: 地域 Id(Required) */
func (r *DeleteScheduledActionRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}

/* param asGroupUuid: 组uuid(Required) */
func (r *DeleteScheduledActionRequest) SetAsGroupUuid(asGroupUuid string) {
    r.AsGroupUuid = asGroupUuid
}

/* param scheduledActionUuid: 定时任务uuid(Required) */
func (r *DeleteScheduledActionRequest) SetScheduledActionUuid(scheduledActionUuid string) {
    r.ScheduledActionUuid = scheduledActionUuid
}

// GetRegionId returns path parameter 'regionId' if exist,
// otherwise return empty string
func (r DeleteScheduledActionRequest) GetRegionId() string {
    return r.RegionId
}
...
type DeleteScheduledActionResponse struct {
    ...
    Result DeleteScheduledActionResult `json:"result"`
}

type DeleteScheduledActionResult struct {
}