...
type DescribeQuotaRequest struct {
    ...
    /* 资源类型，取值范围：bgw、connection、vif、bgw_route  */
    Type string `json:"type"`

    /* type为：bgw、connection、vif不设置, type为bgw_route设置为bgwId (Optional) */
    ParentResourceId *string `json:"parentResourceId"`
}

/*
 * param regionId: Region ID (Required)
 * param type_: 资源类型，取值范围：bgw、connection、vif、bgw_route (Required)
 *
 ...
 * param regionId: Region ID (Required)
 * param type_: 资源类型，取值范围：bgw、connection、vif、bgw_route (Required)
 * param parentResourceId: type为：bgw、connection、vif不设置, type为bgw_route设置为bgwId (Optional)
 */
