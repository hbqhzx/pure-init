...
type RemovePermissionRequest struct {
    ...
    /*   */
    Body *jqs.PbRemovePermissionInput `json:"body"`
}
...
func NewRemovePermissionRequest(
    regionId string,
    queueId string,
    body *jqs.PbRemovePermissionInput,
) *RemovePermissionRequest {

	return &RemovePermissionRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/queue/{queueId}:removePermission",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param queueId: (Required) */
func (r *RemovePermissionRequest) SetQueueId(queueId string) {
    r.QueueId = queueId
}

/* param body: (Required) */
func (r *RemovePermissionRequest) SetBody(body *jqs.PbRemovePermissionInput) {
    r.Body = body
}
