...
type AddPermissionRequest struct {
    ...
    /*   */
    Body *jqs.PbAddPermissionInput `json:"body"`
}
...
func NewAddPermissionRequest(
    regionId string,
    queueId string,
    body *jqs.PbAddPermissionInput,
) *AddPermissionRequest {

	return &AddPermissionRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/queue/{queueId}:addPermission",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param queueId: (Required) */
func (r *AddPermissionRequest) SetQueueId(queueId string) {
    r.QueueId = queueId
}

/* param body: (Required) */
func (r *AddPermissionRequest) SetBody(body *jqs.PbAddPermissionInput) {
    r.Body = body
}
