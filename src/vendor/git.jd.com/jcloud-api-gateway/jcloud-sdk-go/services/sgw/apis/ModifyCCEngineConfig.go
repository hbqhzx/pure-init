...
type ModifyCCEngineConfigRequest struct {
    ...
    /* 新的ccEngine配置信息  */
    CcEngineConfig *sgw.CcEngineConfig `json:"ccEngineConfig"`
}
...
func NewModifyCCEngineConfigRequest(
    regionId string,
    instanceId string,
    ccEngineConfig *sgw.CcEngineConfig,
...
/* param ccEngineConfig: 新的ccEngine配置信息(Required) */
func (r *ModifyCCEngineConfigRequest) SetCcEngineConfig(ccEngineConfig *sgw.CcEngineConfig) {
