...
type UserConfig struct {
    ...
    /* 防护优先级(数值越小优先级越高，整数取值0-10000)，同一waf实例下所有自定义规则优先级不能相同。 (Optional) */
    ...
    当position为REQUEST_URI时,匹配内容应为一个完整的URL地址。如 https://www.jdcloud.com/
    当position为URI时,匹配内容应为一个有效的URL中PATH的一部分。如 /a.html、/abc/ 、abc/
  */
    MatchStr string `json:"matchStr"`

    /* 是否正则匹配，0否1是，默认0 (Optional) */
    IsRegex *int `json:"isRegex"`
