...
type PutBackSourceConfigurationRequest struct {
    ...
    /* 回源配置规则 (Optional) */
    BackSourceRules []oss.BackSourceRule `json:"backSourceRules"`
}
...
func NewPutBackSourceConfigurationRequestWithAllParams(
    regionId string,
    bucketName string,
    backSourceRules []oss.BackSourceRule,
) *PutBackSourceConfigurationRequest {
...
/* param backSourceRules: 回源配置规则(Optional) */
func (r *PutBackSourceConfigurationRequest) SetBackSourceRules(backSourceRules []oss.BackSourceRule) {
