...
import (
    ...
    nc "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/nc/apis"
    "encoding/json"
    "errors"
)
 ...
 */
func (c *NcClient) ModifyQuota(request *nc.ModifyQuotaRequest) (*nc.ModifyQuotaResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
