...
import (
    ...
    waf "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/waf/apis"
    "encoding/json"
    "errors"
)
...
func (c *WafClient) EnableAntispider(request *waf.EnableAntispiderRequest) (*waf.EnableAntispiderResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &waf.EnableAntispiderResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 获取实例ID及相关信息 */
func (c *WafClient) GetWafInstanceDetail(request *waf.GetWafInstanceDetailRequest) (*waf.GetWafInstanceDetailResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &waf.GetWafInstanceDetailResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
func (c *WafClient) EnableIpban(request *waf.EnableIpbanRequest) (*waf.EnableIpbanResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &waf.EnableIpbanResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 设置cc防护模式 */
func (c *WafClient) AntiModeCc(request *waf.AntiModeCcRequest) (*waf.AntiModeCcResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
...
/* 激活cc */
func (c *WafClient) EnableCc(request *waf.EnableCcRequest) (*waf.EnableCcResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
...
/* 获取网站 */
func (c *WafClient) ListDomainsDetail(request *waf.ListDomainsDetailRequest) (*waf.ListDomainsDetailResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &waf.ListDomainsDetailResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 获取网站接入waf状态 */
func (c *WafClient) AccessWafStatus(request *waf.AccessWafStatusRequest) (*waf.AccessWafStatusResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &waf.AccessWafStatusResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
