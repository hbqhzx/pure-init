...
/* param regionId: 地域ID(Required) */
func (r *DescribeDeploysRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}

/* param pageNumber: 页码；默认为1(Optional) */
func (r *DescribeDeploysRequest) SetPageNumber(pageNumber int) {
...
deployId - 应用名，精确匹配
(Optional) */
func (r *DescribeDeploysRequest) SetFilters(filters []common.Filter) {
    r.Filters = filters
}
