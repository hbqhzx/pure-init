...
type GetDistributorListForErpRequest struct {
 ...
 */
func NewGetDistributorListForErpRequest(
    regionId string,
) *GetDistributorListForErpRequest {

	return &GetDistributorListForErpRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/distributorManage/getDistributorListForErp",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
 ...
 */
func NewGetDistributorListForErpRequestWithAllParams(
    regionId string,
...
func NewGetDistributorListForErpRequestWithoutParam() *GetDistributorListForErpRequest {
...
/* param regionId: (Required) */
func (r *GetDistributorListForErpRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}

/* param distributorId: 渠道商ID(Optional) */
func (r *GetDistributorListForErpRequest) SetDistributorId(distributorId string) {
    r.DistributorId = &distributorId
}

/* param distributorName: 渠道商名称(Optional) */
func (r *GetDistributorListForErpRequest) SetDistributorName(distributorName string) {
    r.DistributorName = &distributorName
}

/* param pin: 京东云账户(Optional) */
func (r *GetDistributorListForErpRequest) SetPin(pin string) {
    r.Pin = &pin
}

/* param contractNo: 合同编号(Optional) */
func (r *GetDistributorListForErpRequest) SetContractNo(contractNo string) {
    r.ContractNo = &contractNo
}

/* param businessLicense: 营业执照号(Optional) */
func (r *GetDistributorListForErpRequest) SetBusinessLicense(businessLicense string) {
    r.BusinessLicense = &businessLicense
}

/* param legalRepresentative: 法定代表人(Optional) */
func (r *GetDistributorListForErpRequest) SetLegalRepresentative(legalRepresentative string) {
    r.LegalRepresentative = &legalRepresentative
}

/* param businessLicensePic: 营业执照图片(Optional) */
func (r *GetDistributorListForErpRequest) SetBusinessLicensePic(businessLicensePic string) {
    r.BusinessLicensePic = &businessLicensePic
}

/* param businessDesc: 主营业务描述(Optional) */
func (r *GetDistributorListForErpRequest) SetBusinessDesc(businessDesc string) {
    r.BusinessDesc = &businessDesc
}

/* param workAddress: 办公地址(Optional) */
func (r *GetDistributorListForErpRequest) SetWorkAddress(workAddress string) {
    r.WorkAddress = &workAddress
}

/* param contracter: 联系人姓名(Optional) */
func (r *GetDistributorListForErpRequest) SetContracter(contracter string) {
    r.Contracter = &contracter
}

/* param tel: 联系人电话(Optional) */
func (r *GetDistributorListForErpRequest) SetTel(tel string) {
    r.Tel = &tel
}

/* param email: 邮箱(Optional) */
func (r *GetDistributorListForErpRequest) SetEmail(email string) {
    r.Email = &email
}

/* param region: 所属地域(Optional) */
func (r *GetDistributorListForErpRequest) SetRegion(region string) {
    r.Region = &region
}

/* param settleTime: 入驻日期(一级渠道商手工录入、二级渠道商审批通过日期)(Optional) */
func (r *GetDistributorListForErpRequest) SetSettleTime(settleTime string) {
    r.SettleTime = &settleTime
}

/* param status: 状态(0 审批中、2驳回、1 已入驻、3已停止合作)(Optional) */
func (r *GetDistributorListForErpRequest) SetStatus(status int) {
    r.Status = &status
}

/* param reason: 驳回原因(Optional) */
func (r *GetDistributorListForErpRequest) SetReason(reason string) {
    r.Reason = &reason
}

/* param distributorLevel: 级次(0一级、1 二级)(Optional) */
func (r *GetDistributorListForErpRequest) SetDistributorLevel(distributorLevel int) {
    r.DistributorLevel = &distributorLevel
}

/* param distributorType: 渠道商类型(0合作伙伴、1 渠道代理)(Optional) */
func (r *GetDistributorListForErpRequest) SetDistributorType(distributorType int) {
    r.DistributorType = &distributorType
}

/* param parentPin: 上级渠道商pin(Optional) */
func (r *GetDistributorListForErpRequest) SetParentPin(parentPin string) {
    r.ParentPin = &parentPin
}

/* param parentDistributorId: 上级渠道商ID(Optional) */
func (r *GetDistributorListForErpRequest) SetParentDistributorId(parentDistributorId string) {
    r.ParentDistributorId = &parentDistributorId
}

/* param parentDistributorName: 上级渠道商名称(Optional) */
func (r *GetDistributorListForErpRequest) SetParentDistributorName(parentDistributorName string) {
    r.ParentDistributorName = &parentDistributorName
}

/* param dept: 所属部门(0企业线、1政府线)(Optional) */
func (r *GetDistributorListForErpRequest) SetDept(dept int) {
    r.Dept = &dept
}

/* param erp: 京东云负责人(京东云人员erp或名称)(Optional) */
func (r *GetDistributorListForErpRequest) SetErp(erp string) {
    r.Erp = &erp
}

/* param settleTimeBegin: 入驻条件开始日期(Optional) */
func (r *GetDistributorListForErpRequest) SetSettleTimeBegin(settleTimeBegin string) {
    r.SettleTimeBegin = &settleTimeBegin
}

/* param settleTimeEnd: 入驻条件结束日期(Optional) */
func (r *GetDistributorListForErpRequest) SetSettleTimeEnd(settleTimeEnd string) {
    r.SettleTimeEnd = &settleTimeEnd
}

/* param pageIndex: 当前页序号(Optional) */
func (r *GetDistributorListForErpRequest) SetPageIndex(pageIndex int) {
    r.PageIndex = &pageIndex
}

/* param pageSize: 每页结果数量(Optional) */
func (r *GetDistributorListForErpRequest) SetPageSize(pageSize int) {
    r.PageSize = &pageSize
}

/* param offset: (Optional) */
func (r *GetDistributorListForErpRequest) SetOffset(offset int) {
    r.Offset = &offset
}

// GetRegionId returns path parameter 'regionId' if exist,
// otherwise return empty string
func (r GetDistributorListForErpRequest) GetRegionId() string {
    return r.RegionId
}

type GetDistributorListForErpResponse struct {
    RequestID string `json:"requestId"`
    Error core.ErrorResponse `json:"error"`
    Result GetDistributorListForErpResult `json:"result"`
}

type GetDistributorListForErpResult struct {
