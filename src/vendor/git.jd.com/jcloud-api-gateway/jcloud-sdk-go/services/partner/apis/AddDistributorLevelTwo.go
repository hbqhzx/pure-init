...
type AddDistributorLevelTwoRequest struct {
 ...
 */
func NewAddDistributorLevelTwoRequest(
    regionId string,
) *AddDistributorLevelTwoRequest {

	return &AddDistributorLevelTwoRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/distributorManage/addDistributorLevelTwo",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
 ...
 */
func NewAddDistributorLevelTwoRequestWithAllParams(
    regionId string,
...
func NewAddDistributorLevelTwoRequestWithoutParam() *AddDistributorLevelTwoRequest {
...
/* param regionId: (Required) */
func (r *AddDistributorLevelTwoRequest) SetRegionId(regionId string) {
    r.RegionId = regionId
}

/* param distributorId: 渠道商ID(Optional) */
func (r *AddDistributorLevelTwoRequest) SetDistributorId(distributorId string) {
    r.DistributorId = &distributorId
}

/* param distributorName: 渠道商名称(Optional) */
func (r *AddDistributorLevelTwoRequest) SetDistributorName(distributorName string) {
    r.DistributorName = &distributorName
}

/* param pin: 京东云账户(Optional) */
func (r *AddDistributorLevelTwoRequest) SetPin(pin string) {
    r.Pin = &pin
}

/* param contractNo: 合同编号(Optional) */
func (r *AddDistributorLevelTwoRequest) SetContractNo(contractNo string) {
    r.ContractNo = &contractNo
}

/* param businessLicense: 营业执照号(Optional) */
func (r *AddDistributorLevelTwoRequest) SetBusinessLicense(businessLicense string) {
    r.BusinessLicense = &businessLicense
}

/* param legalRepresentative: 法定代表人(Optional) */
func (r *AddDistributorLevelTwoRequest) SetLegalRepresentative(legalRepresentative string) {
    r.LegalRepresentative = &legalRepresentative
}

/* param businessLicensePic: 营业执照图片(Optional) */
func (r *AddDistributorLevelTwoRequest) SetBusinessLicensePic(businessLicensePic string) {
    r.BusinessLicensePic = &businessLicensePic
}

/* param businessDesc: 主营业务描述(Optional) */
func (r *AddDistributorLevelTwoRequest) SetBusinessDesc(businessDesc string) {
    r.BusinessDesc = &businessDesc
}

/* param workAddress: 办公地址(Optional) */
func (r *AddDistributorLevelTwoRequest) SetWorkAddress(workAddress string) {
    r.WorkAddress = &workAddress
}

/* param contracter: 联系人姓名(Optional) */
func (r *AddDistributorLevelTwoRequest) SetContracter(contracter string) {
    r.Contracter = &contracter
}

/* param tel: 联系人电话(Optional) */
func (r *AddDistributorLevelTwoRequest) SetTel(tel string) {
    r.Tel = &tel
}

/* param email: 邮箱(Optional) */
func (r *AddDistributorLevelTwoRequest) SetEmail(email string) {
    r.Email = &email
}

/* param region: 所属地域(Optional) */
func (r *AddDistributorLevelTwoRequest) SetRegion(region string) {
    r.Region = &region
}

/* param settleTime: 入驻日期(一级渠道商手工录入、二级渠道商审批通过日期)(Optional) */
func (r *AddDistributorLevelTwoRequest) SetSettleTime(settleTime string) {
    r.SettleTime = &settleTime
}

/* param status: 状态(0 审批中、2驳回、1 已入驻、3已停止合作)(Optional) */
func (r *AddDistributorLevelTwoRequest) SetStatus(status int) {
    r.Status = &status
}

/* param reason: 驳回原因(Optional) */
func (r *AddDistributorLevelTwoRequest) SetReason(reason string) {
    r.Reason = &reason
}

/* param distributorLevel: 级次(0一级、1 二级)(Optional) */
func (r *AddDistributorLevelTwoRequest) SetDistributorLevel(distributorLevel int) {
    r.DistributorLevel = &distributorLevel
}

/* param distributorType: 渠道商类型(0合作伙伴、1 渠道代理)(Optional) */
func (r *AddDistributorLevelTwoRequest) SetDistributorType(distributorType int) {
    r.DistributorType = &distributorType
}

/* param parentDistributorId: 上级渠道商ID(Optional) */
func (r *AddDistributorLevelTwoRequest) SetParentDistributorId(parentDistributorId string) {
    r.ParentDistributorId = &parentDistributorId
}

/* param bankCompanyName: 银行开户名(Optional) */
func (r *AddDistributorLevelTwoRequest) SetBankCompanyName(bankCompanyName string) {
    r.BankCompanyName = &bankCompanyName
}

/* param bankCardNo: 银行账户(Optional) */
func (r *AddDistributorLevelTwoRequest) SetBankCardNo(bankCardNo string) {
    r.BankCardNo = &bankCardNo
}

/* param bankBranchName: 开户行支行名称(Optional) */
func (r *AddDistributorLevelTwoRequest) SetBankBranchName(bankBranchName string) {
    r.BankBranchName = &bankBranchName
}

/* param bankBranchNo: 开户行支行联行号(Optional) */
func (r *AddDistributorLevelTwoRequest) SetBankBranchNo(bankBranchNo string) {
    r.BankBranchNo = &bankBranchNo
}

/* param contractSubject: 合同主体(Optional) */
func (r *AddDistributorLevelTwoRequest) SetContractSubject(contractSubject string) {
    r.ContractSubject = &contractSubject
}

/* param dept: 所属部门(0企业线、1政府线)(Optional) */
func (r *AddDistributorLevelTwoRequest) SetDept(dept int) {
    r.Dept = &dept
}

/* param erp: 京东云负责人(京东云人员erp或名称)(Optional) */
func (r *AddDistributorLevelTwoRequest) SetErp(erp string) {
    r.Erp = &erp
}

// GetRegionId returns path parameter 'regionId' if exist,
// otherwise return empty string
func (r AddDistributorLevelTwoRequest) GetRegionId() string {
    return r.RegionId
}

type AddDistributorLevelTwoResponse struct {
    RequestID string `json:"requestId"`
    Error core.ErrorResponse `json:"error"`
    Result AddDistributorLevelTwoResult `json:"result"`
}

type AddDistributorLevelTwoResult struct {
