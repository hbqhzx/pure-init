...
import (
    ...
    rds "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/rds/apis"
    "encoding/json"
    "errors"
)
...
/* 验证实例规格有效性 */
func (c *RdsClient) StandardVerify(request *rds.StandardVerifyRequest) (*rds.StandardVerifyResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.StandardVerifyResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 校验需要导入的备份文件在OSS上是否存在，需要的读取权限是否具备<br>- 仅支持SQL Server */
func (c *RdsClient) VerifyFilefromOSS(request *rds.VerifyFilefromOSSRequest) (*rds.VerifyFilefromOSSResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.VerifyFilefromOSSResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 聚合rds产品线的selectDetailList接口，支持传入混合资源ID，对于不存在或错误的资源ID，不返还结果 */
func (c *RdsClient) SelectDetailList(request *rds.SelectDetailListRequest) (*rds.SelectDetailListResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.SelectDetailListResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查看各地域下允许创建的RDS实例及手工备份的最大数目 */
func (c *RdsClient) DescribeQuotas(request *rds.DescribeQuotasRequest) (*rds.DescribeQuotasResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.DescribeQuotasResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 创建数据库账号，用户可以使用客户端，应用程序等通过该账号和密码登录RDS数据库实例。<br>为便于管理和恢复，RDS对账号进行了限制，数据库账号只能通过控制台或者OpenAPI进行创建、删除账号以及对账号授权等，用户不能通过SQL语句对账号进行相关操作。<br>- 内部接口，暂不对外开放 */
func (c *RdsClient) CreateAccountWithPrivilege(request *rds.CreateAccountWithPrivilegeRequest) (*rds.CreateAccountWithPrivilegeResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.CreateAccountWithPrivilegeResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 校验资源有效性，例如给定资源是否属于本用户，内部接口 */
func (c *RdsClient) VerifyInstanceValidation(request *rds.VerifyInstanceValidationRequest) (*rds.VerifyInstanceValidationResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.VerifyInstanceValidationResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 在进行实例降配的时候，需要底层提供可以进行降配选择的最低存储空间大小，前端可以根据这个值去筛选可用的规格列表。<br>- 仅支持MySQL */
func (c *RdsClient) DescribeStorageUsed(request *rds.DescribeStorageUsedRequest) (*rds.DescribeStorageUsedResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.DescribeStorageUsedResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 修改RDS实例备份策略, 只支持内部调用 */
func (c *RdsClient) ModifyFullBackupPolicy(request *rds.ModifyFullBackupPolicyRequest) (*rds.ModifyFullBackupPolicyResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.ModifyFullBackupPolicyResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 创建一个数据库，同时授予用户访问权限。 为了实例的管理和数据恢复，RDS对用户权限进行了限制，用户仅能通过控制台或本接口创建数据库<br>- 内部接口，暂不对外开放 */
func (c *RdsClient) CreateDatabaseWithPrivilege(request *rds.CreateDatabaseWithPrivilegeRequest) (*rds.CreateDatabaseWithPrivilegeResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &rds.CreateDatabaseWithPrivilegeResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 根据跨地域备份同步服务时间点创建实例。<br>- 仅支持MySQL */
