...
/* param instanceId: 高防实例 Id(Required) */
func (r *DescribeCCProtectionRulesOfWebRuleRequest) SetInstanceId(instanceId int) {
    r.InstanceId = instanceId
}

/* param webRuleId: 网站规则 Id(Required) */
func (r *DescribeCCProtectionRulesOfWebRuleRequest) SetWebRuleId(webRuleId int) {
