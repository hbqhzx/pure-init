...
/* param instanceId: 高防实例 Id(Required) */
func (r *DescribeWhiteListRuleOfForwardRuleRequest) SetInstanceId(instanceId int) {
    r.InstanceId = instanceId
}

/* param forwardRuleId: 转发规则 Id(Required) */
func (r *DescribeWhiteListRuleOfForwardRuleRequest) SetForwardRuleId(forwardRuleId int) {
