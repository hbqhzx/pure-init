...
/* param instanceId: 高防实例 Id(Required) */
func (r *EnableCCProtectionRuleOfWebRuleRequest) SetInstanceId(instanceId int) {
    r.InstanceId = instanceId
}

/* param webRuleId: 网站规则 Id(Required) */
func (r *EnableCCProtectionRuleOfWebRuleRequest) SetWebRuleId(webRuleId int) {
    r.WebRuleId = webRuleId
}

/* param ccProtectionRuleId: 网站类规则的 CC 防护规则 Id(Required) */
func (r *EnableCCProtectionRuleOfWebRuleRequest) SetCcProtectionRuleId(ccProtectionRuleId int) {
