...
/* param instanceId: 高防实例 Id(Required) */
func (r *DescribeCCProtectionDefaultConfigOfWebRuleRequest) SetInstanceId(instanceId int) {
    r.InstanceId = instanceId
}

/* param webRuleId: 网站规则 Id(Required) */
func (r *DescribeCCProtectionDefaultConfigOfWebRuleRequest) SetWebRuleId(webRuleId int) {
