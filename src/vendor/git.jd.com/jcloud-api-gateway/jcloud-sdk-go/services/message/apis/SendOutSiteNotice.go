...
type SendOutSiteNoticeRequest struct {
    ...
    /* 站外信接口  */
    SendOutSiteNoticeReqVo *message.SendOutSiteNotice `json:"sendOutSiteNoticeReqVo"`
}
...
func NewSendOutSiteNoticeRequest(
    sendOutSiteNoticeReqVo *message.SendOutSiteNotice,
...
/* param sendOutSiteNoticeReqVo: 站外信接口(Required) */
func (r *SendOutSiteNoticeRequest) SetSendOutSiteNoticeReqVo(sendOutSiteNoticeReqVo *message.SendOutSiteNotice) {
