...
import (
    ...
    cps "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/cps/apis"
    "encoding/json"
    "errors"
)
...
不能删除没有计费信息的服务器<br/>
 */
func (c *CpsClient) DeleteInstance(request *cps.DeleteInstanceRequest) (*cps.DeleteInstanceResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &cps.DeleteInstanceResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 申请弹性公网IP
 */
func (c *CpsClient) ApplayElasticIps(request *cps.ApplayElasticIpsRequest) (*cps.ApplayElasticIpsResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &cps.ApplayElasticIpsResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 删除弹性公网IP
 */
func (c *CpsClient) DeleteelasticIp(request *cps.DeleteelasticIpRequest) (*cps.DeleteelasticIpResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &cps.DeleteelasticIpResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
