...
/*
 * param regionId: Region ID (Required)
 * param masterVerson: 集群的大版本，如 1.8.12 (Optional)
...
/* param masterVerson: 集群的大版本，如 1.8.12(Optional) */
func (r *DescribeImagesRequest) SetMasterVerson(masterVerson string) {
...
type DescribeImagesResult struct {
    MasterImages []jke.MasterImage `json:"masterImages"`
}