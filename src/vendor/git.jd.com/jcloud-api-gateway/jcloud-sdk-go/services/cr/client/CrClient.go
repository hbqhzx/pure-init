...
import (
    ...
    cr "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/cr/apis"
    "encoding/json"
    "errors"
)
...
/* 修改配额（内部接口） */
func (c *CrClient) ModifyQuota(request *cr.ModifyQuotaRequest) (*cr.ModifyQuotaResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
