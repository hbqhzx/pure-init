 ...
 * param domainName: 需要检查的域名 (Required)
 * param packId: 套餐类型, 只能是：0->免费 ,1->企业版 (Required)
 *
...
func NewCheckDomainRequest(
	...
	return &CheckDomainRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/checkDomain",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param packId: 套餐类型, 只能是：0->免费 ,1->企业版(Required) */
func (r *CheckDomainRequest) SetPackId(packId int) {
    r.PackId = packId
}
