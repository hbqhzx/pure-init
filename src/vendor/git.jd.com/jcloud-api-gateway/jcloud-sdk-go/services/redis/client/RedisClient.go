...
import (
    ...
    redis "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/redis/apis"
    "encoding/json"
    "errors"
)
...
/* 修改账户的缓存Redis配额 */
func (c *RedisClient) ModifyUserQuota(request *redis.ModifyUserQuotaRequest) (*redis.ModifyUserQuotaResponse, error) {
    if request == nil {
    ...
    jdResp := &redis.ModifyUserQuotaResponse{}
...
/* 停止用户访问缓存Redis实例 */
func (c *RedisClient) StopInstance(request *redis.StopInstanceRequest) (*redis.StopInstanceResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &redis.StopInstanceResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查询缓存Redis开放的功能 */
func (c *RedisClient) DescribeSupportedFunction(request *redis.DescribeSupportedFunctionRequest) (*redis.DescribeSupportedFunctionResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &redis.DescribeSupportedFunctionResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查询订单结果 */
func (c *RedisClient) DescribeOrderStatus(request *redis.DescribeOrderStatusRequest) (*redis.DescribeOrderStatusResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &redis.DescribeOrderStatusResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 恢复用户访问缓存Redis实例 */
func (c *RedisClient) StartInstance(request *redis.StartInstanceRequest) (*redis.StartInstanceResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &redis.StartInstanceResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查询缓存Redis实例的资源名称 */
func (c *RedisClient) DescribeInstanceNames(request *redis.DescribeInstanceNamesRequest) (*redis.DescribeInstanceNamesResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &redis.DescribeInstanceNamesResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 修改规格的可见性 */
func (c *RedisClient) ModifyInstanceClass(request *redis.ModifyInstanceClassRequest) (*redis.ModifyInstanceClassResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &redis.ModifyInstanceClassResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
