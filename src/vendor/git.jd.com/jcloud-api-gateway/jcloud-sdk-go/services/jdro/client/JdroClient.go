...
import (
    ...
    jdro "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/jdro/apis"
    "encoding/json"
    "errors"
)
...
/* 查询更改集列表 */
func (c *JdroClient) DescribeChangeSetList(request *jdro.DescribeChangeSetListRequest) (*jdro.DescribeChangeSetListResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.DescribeChangeSetListResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查询模板列表 */
func (c *JdroClient) DescribeTemplates(request *jdro.DescribeTemplatesRequest) (*jdro.DescribeTemplatesResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.DescribeTemplatesResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 更新模板 */
func (c *JdroClient) UpdateTemplate(request *jdro.UpdateTemplateRequest) (*jdro.UpdateTemplateResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.UpdateTemplateResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 删除模板 */
func (c *JdroClient) DeleteTemplate(request *jdro.DeleteTemplateRequest) (*jdro.DeleteTemplateResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.DeleteTemplateResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查询模板内容 */
func (c *JdroClient) DescribeTemplatesByID(request *jdro.DescribeTemplatesByIDRequest) (*jdro.DescribeTemplatesByIDResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.DescribeTemplatesByIDResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 取消当前资源栈操作 */
func (c *JdroClient) CancelStack(request *jdro.CancelStackRequest) (*jdro.CancelStackResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.CancelStackResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 堆栈执行进度 */
func (c *JdroClient) DescribeStackProgresses(request *jdro.DescribeStackProgressesRequest) (*jdro.DescribeStackProgressesResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.DescribeStackProgressesResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 查询更改集详情 */
func (c *JdroClient) DescribeChangeSet(request *jdro.DescribeChangeSetRequest) (*jdro.DescribeChangeSetResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.DescribeChangeSetResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
...
/* 创建模板 */
func (c *JdroClient) CreateTemplate(request *jdro.CreateTemplateRequest) (*jdro.CreateTemplateResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &jdro.CreateTemplateResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
