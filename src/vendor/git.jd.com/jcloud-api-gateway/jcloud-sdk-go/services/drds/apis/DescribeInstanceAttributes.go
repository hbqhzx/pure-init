...
import (
    ...
    drds "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/drds/models"
)
...
type DescribeInstanceAttributesRequest struct {
    ...
    /* DRDS 实例ID，唯一标识一个DRDS实例  */
    InstanceId string `json:"instanceId"`
}

/*
 * param regionId: 地域代码，取值范围参见[《各地域及可用区对照表》](../Enum-Definitions/Regions-AZ.md) (Required)
 * param instanceId: DRDS 实例ID，唯一标识一个DRDS实例 (Required)
 *
...
type DescribeInstanceAttributesResult struct {
    InstanceAttributes drds.InstanceAttribute `json:"instanceAttributes"`
}