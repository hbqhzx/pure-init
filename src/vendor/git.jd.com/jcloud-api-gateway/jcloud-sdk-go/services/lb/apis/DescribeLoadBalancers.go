...
type DescribeLoadBalancersRequest struct {
    ...
    /* loadBalancerType - 负载均衡类型，取值为：alb、nlb，默认alb，支持单个
loadBalancerIds - 负载均衡ID列表，支持多个
loadBalancerNames - 负载均衡名称列表，支持多个
vpcId - 负载均衡所在Vpc的Id，支持单个
nlbMode - nlb类型LoadBalancer的模式，只对nlb有效。取值为：fsr(fast server return)或fullnat
 (Optional) */
 ...
 * param filters: loadBalancerType - 负载均衡类型，取值为：alb、nlb，默认alb，支持单个
loadBalancerIds - 负载均衡ID列表，支持多个
loadBalancerNames - 负载均衡名称列表，支持多个
vpcId - 负载均衡所在Vpc的Id，支持单个
nlbMode - nlb类型LoadBalancer的模式，只对nlb有效。取值为：fsr(fast server return)或fullnat
