 ...
 * param protocol: 监听协议, 取值为Tcp, Tls, Http, Https【alb】支持Http, Https，Tcp和Tls【nlb】支持Tcp (Required)
 ...
 * param connectionIdleTimeSeconds: 连接保持时间, >=1，范围为[1,86400]。【Tcp和Tls协议】默认为：1800s【Http和Https协议】默认为：60s (Optional)
