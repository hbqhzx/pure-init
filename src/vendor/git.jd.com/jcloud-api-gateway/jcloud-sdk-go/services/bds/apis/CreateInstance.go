...
type CreateInstanceRequest struct {
    ...
    /* 新建实例规格  */
    InstanceSpec *bds.InstanceSpec `json:"instanceSpec"`
}
...
/* param instanceSpec: 新建实例规格(Required) */
func (r *CreateInstanceRequest) SetInstanceSpec(instanceSpec *bds.InstanceSpec) {
