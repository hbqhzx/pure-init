...
type CreateInstanceRequest struct {
    ...
    InstanceSpec *tsds.InstanceSpec `json:"instanceSpec"`
}

/*
 * param regionId: Region ID (Required)
 * param instanceSpec: Create instance parameters (Required)
 *
 * @Deprecated, not compatible when mandatory parameters changed
 */
func NewCreateInstanceRequest(
    regionId string,
    instanceSpec *tsds.InstanceSpec,
...
/* param instanceSpec: Create instance parameters(Required) */
func (r *CreateInstanceRequest) SetInstanceSpec(instanceSpec *tsds.InstanceSpec) {
