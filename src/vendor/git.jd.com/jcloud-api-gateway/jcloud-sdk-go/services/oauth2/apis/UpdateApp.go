...
/* param responseTypes: responseTypes(Optional) */
func (r *UpdateAppRequest) SetResponseTypes(responseTypes string) {
...
/* param multiTenant: multiTenant(Optional) */
func (r *UpdateAppRequest) SetMultiTenant(multiTenant int) {
...
/* param secretUpdateTime: secretUpdateTime(Optional) */
func (r *UpdateAppRequest) SetSecretUpdateTime(secretUpdateTime int) {
    r.SecretUpdateTime = &secretUpdateTime
}

/* param account: account(Optional) */
func (r *UpdateAppRequest) SetAccount(account string) {
    r.Account = &account
}
