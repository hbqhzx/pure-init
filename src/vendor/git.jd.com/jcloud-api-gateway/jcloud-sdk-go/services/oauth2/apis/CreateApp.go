...
type CreateAppRequest struct {
    ...
    SecretUpdateTime *int `json:"secretUpdateTime"`
 ...
 * param responseTypes: responseTypes (Optional)
 ...
 * param secretUpdateTime: secretUpdateTime (Optional)
...
/* param responseTypes: responseTypes(Optional) */
func (r *CreateAppRequest) SetResponseTypes(responseTypes string) {
...
/* param multiTenant: multiTenant(Optional) */
func (r *CreateAppRequest) SetMultiTenant(multiTenant int) {
...
/* param secretUpdateTime: secretUpdateTime(Optional) */
func (r *CreateAppRequest) SetSecretUpdateTime(secretUpdateTime int) {
    r.SecretUpdateTime = &secretUpdateTime
}

/* param account: account(Optional) */
func (r *CreateAppRequest) SetAccount(account string) {
    r.Account = &account
}
