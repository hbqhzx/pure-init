...
type CreateInstanceRequest struct {
    ...
    /* 新建实例规格  */
    InstanceSpec *jdw.DBInstanceSpec `json:"instanceSpec"`
}
...
func NewCreateInstanceRequest(
    regionId string,
    instanceSpec *jdw.DBInstanceSpec,
...
/* param instanceSpec: 新建实例规格(Required) */
func (r *CreateInstanceRequest) SetInstanceSpec(instanceSpec *jdw.DBInstanceSpec) {
