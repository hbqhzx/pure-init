...
type EnableSiteMonitorRequest struct {
    ...
    /*  (Optional) */
    List []monitor.EnableSiteMonitorReqItem `json:"list"`
}
...
func NewEnableSiteMonitorRequestWithAllParams(
    list []monitor.EnableSiteMonitorReqItem,
) *EnableSiteMonitorRequest {
...
/* param list: (Optional) */
func (r *EnableSiteMonitorRequest) SetList(list []monitor.EnableSiteMonitorReqItem) {
    r.List = list
}
