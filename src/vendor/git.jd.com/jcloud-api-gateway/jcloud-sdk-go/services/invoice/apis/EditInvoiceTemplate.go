...
/* param id: id(Optional) */
func (r *EditInvoiceTemplateRequest) SetId(id int64) {
    r.Id = &id
}

/* param invoiceType: 发票类型(Optional) */
func (r *EditInvoiceTemplateRequest) SetInvoiceType(invoiceType int) {
...
/* param vatId: vatId(Optional) */
func (r *EditInvoiceTemplateRequest) SetVatId(vatId int) {
    r.VatId = &vatId
}

/* param type_: type(Optional) */
func (r *EditInvoiceTemplateRequest) SetType(type_ int) {
    r.Type = &type_
}
