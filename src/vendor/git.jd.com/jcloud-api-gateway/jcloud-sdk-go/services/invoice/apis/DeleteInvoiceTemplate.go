...
func NewDeleteInvoiceTemplateRequest(
	...
	return &DeleteInvoiceTemplateRequest{
        JDCloudRequest: core.JDCloudRequest{
			URL:     "/regions/{regionId}/invoice_template:delete",
			Method:  "POST",
			Header:  nil,
			Version: "v1",
		},
...
/* param id: id(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetId(id int64) {
    r.Id = &id
}

/* param invoiceType: 发票类型(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetInvoiceType(invoiceType int) {
    r.InvoiceType = &invoiceType
}

/* param invoiceTitle: 发票抬头(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetInvoiceTitle(invoiceTitle string) {
    r.InvoiceTitle = &invoiceTitle
}

/* param invoiceContent: 发票内容(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetInvoiceContent(invoiceContent string) {
    r.InvoiceContent = &invoiceContent
}

/* param taxId: 税号(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetTaxId(taxId string) {
    r.TaxId = &taxId
}

/* param company: 公司(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetCompany(company string) {
    r.Company = &company
}

/* param phone: 手机号(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetPhone(phone string) {
    r.Phone = &phone
}

/* param bank: 开户行(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetBank(bank string) {
    r.Bank = &bank
}

/* param account: 开户账号(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetAccount(account string) {
    r.Account = &account
}

/* param address: 开户行地址(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetAddress(address string) {
    r.Address = &address
}

/* param email: 邮箱(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetEmail(email string) {
    r.Email = &email
}

/* param vatId: vatId(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetVatId(vatId int) {
    r.VatId = &vatId
}

/* param type_: type(Optional) */
func (r *DeleteInvoiceTemplateRequest) SetType(type_ int) {
    r.Type = &type_
}
