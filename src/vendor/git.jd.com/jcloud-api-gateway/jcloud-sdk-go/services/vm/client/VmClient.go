...
import (
    ...
    vm "git.jd.com/jcloud-api-gateway/jcloud-sdk-go/services/vm/apis"
    "encoding/json"
    "errors"
)
 ...
 */
func (c *VmClient) ModifyQuota(request *vm.ModifyQuotaRequest) (*vm.ModifyQuotaResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
 ...
 */
func (c *VmClient) ConvertImage(request *vm.ConvertImageRequest) (*vm.ConvertImageResponse, error) {
    if request == nil {
        return nil, errors.New("Request object is nil. ")
    }
    resp, err := c.Send(request, c.ServiceName)
    ...
    jdResp := &vm.ConvertImageResponse{}
    err = json.Unmarshal(resp, jdResp)
    if err != nil {
        c.Logger.Log(core.LogError, "Unmarshal json failed, resp: %s", string(resp))
        return nil, err
